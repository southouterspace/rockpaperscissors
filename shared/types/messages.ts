...
export interface OnlineUser {
  ...
  inRoom: boolean;
  roomCode?: string;
  pendingInvitation?: string; // roomCode if they have a pending invitation from a room
}
...
export interface RoomState {
  ...
  readyPlayers?: string[];
  timeoutsRemaining: Record<string, number>; // playerId -> timeouts remaining (0 or 1)
  activeTimeout: {
    playerId: string;
